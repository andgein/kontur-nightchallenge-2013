...
namespace Core.Parser
{
	public class ExpressionParser : Parser
	{
		...
		private void NextLexem()
		{
			...
			LexemType lexemType;
			if (!allowedArithmeticExpressionLexems.TryGetValue(State.Current, out lexemType))
			{
				currentLexem = new Lexem(LexemType.End);
				return;
			}
		...
		private static readonly Dictionary<char, LexemType> allowedArithmeticExpressionLexems = new Dictionary<char, LexemType>
		{
